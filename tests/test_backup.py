...
class BackupTests(unittest.TestCase):
    ...
    def test_keyword_only_args(self):
        with self.assertRaises(TypeError):
            with monetdbe.connect(':memory:') as bck:
    ...
    def test_progress(self):
        ...
        self.assertEqual(journal[0], monetdbe.monetdbe_OK)
        self.assertEqual(journal[1], monetdbe.monetdbe_DONE)

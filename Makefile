...
docker-wheels:
	...
	docker run -v `pwd`:$(GITHUB_WORKSPACE) ${WHEEL_IMAGE} sh -c "cd $(GITHUB_WORKSPACE); scripts/make_wheel.sh 3.10"
...
osx-m1-all-wheels: venv38/ venv39/ venv310/
	...
	MONETDB_BRANCH=Jul2021 CFLAGS="-I/Users/gijs/opt/monetdb/include -L/Users/gijs/opt/monetdb/lib" venv38/bin/python -m build
	MONETDB_BRANCH=Jul2021 CFLAGS="-I/Users/gijs/opt/monetdb/include -L/Users/gijs/opt/monetdb/lib" venv39/bin/python -m build
	MONETDB_BRANCH=Jul2021 CFLAGS="-I/Users/gijs/opt/monetdb/include -L/Users/gijs/opt/monetdb/lib" venv310/bin/python -m build
